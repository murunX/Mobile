...
import 'package:BieDaalt/Layouts/Widgets/widget_difficulty_settings.dart';
import 'package:BieDaalt/Layouts/Widgets/widget_music_settings.dart';
import 'package:BieDaalt/Layouts/Widgets/widget_themes_settings.dart';
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  myText("Тохиргоо", Colors.pinkAccent, 35),
                  ThemesSettings(),
                  MusicSettings(),
                  ElevatedButton(
                      ...
                      child: myText("Өөрчлөх", Colors.white, 35)),
                ],
              ),
            ),
          ],
