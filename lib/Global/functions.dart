...
AlertDialog dialog(BuildContext context) {
  return AlertDialog(
    ...
    title: myText("Бидний тухай", Colors.black, 22),
    content: Text(
      Str.about,
...
void navigate(context, navigate) {
  switch (navigate) {
    case Str.create:
      Navigator.pushNamed(context, Str.create);
      break;
    case Str.join:
      Navigator.pushNamed(context, Str.join);
      break;
    case Str.main:
      Navigator.pushNamed(context, Str.main);
      break;
    case Str.Bot:
      Navigator.pushNamed(context, Str.Bot);
      break;
    case Str.create:
      Navigator.pushNamed(context, Str.create);
      break;
    case Str.splash:
      Navigator.pushNamed(context, Str.splash);
      break;
    case Str.join:
      Navigator.pushNamed(context, Str.join);
      break;
